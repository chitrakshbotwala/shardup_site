...
export default async function ApplicationsAdminPage({
  ...
  const activeTab: TabKey =
    TABS.find((tab) => tab.key === searchParams?.status)?.key ?? "pending";
  ...
  return (
    <main className="app-shell">
      <section className="app-card wide-card">
        ...
        <p>
          Review submitted applications and track approved and rejected ones.
          Approving an application grants the applicant member access.
        </p>
                ...
                <article className="application-row" key={application.id}>
                  <div>
                    ...
                    <p className="muted-line">
                      ...
                      {application.cohort ? ` · Cohort ${application.cohort.year}` : ""} ·
                      Submitted {dateFormatter.format(application.createdAt)}
                    </p>
                    <p>
                      <strong>Batch:</strong>{" "}
